...
const TechnicalDrawingView = ({ viewModal, setViewModal, data }) => {
    return (
            ...
            <ModalBody>
                <Row>
                    ...
                    <Col xs={12} sm={12} md={6} lg={6} xl={6} className='mb-3'>
                        ...
                        <div className='mt-1'><strong>Operator Tarihi: </strong><span>{new Date(data?.operatorDate).toLocaleDateString()}</span></div>
